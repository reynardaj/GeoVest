    ...
    <nav className="flex items-center justify-between px-10 py-4 w-full">
      <div className="flex items-center">
        <Link href="/" className="flex items-center">
          <Image src="/logo-news.png" alt="GeoVest Logo" width={42} height={42} />
        </Link>
        <div className="ml-8 hidden md:flex space-x-10">
          <Link href="/features" className="text-[#17488D] hover:text-[#376ab1] transition-colors font-inter font-semibold">
            Features
          </Link>
