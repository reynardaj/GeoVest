...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        fetch('/properties.geojson')
            ...
            .then((data: GeoJSONData) => {
                const propertiesFromGeoJSON: Property[] = data.features.map((feature: GeoJSONFeature, index) => {
                    ...
                    return {
                        ...
                        location: prop.property_name.split(',')[1] ? prop.property_name.split(',')[1].trim() : "Jakarta",
                        price: formatCurrency(prop.property_price),
                        category: prop.property_category,
                        landArea: `${prop.land_area} m²`,
                        // Include the property ID in the coordinates for use in map focusing
                        coordinates: [geometry.coordinates[0], geometry.coordinates[1], propertyId],
                ...
                if (storedFormData) {
                    ...
                    const recommended = recommendProperties(propertiesFromGeoJSON, parsedFormData);
    ...
    const recommendProperties = (allProperties: Property[], formData: FormData): Property[] => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 p-12 overflow-x-hidden">
                ...
                <div className="lg:col-span-3 space-y-6 bg-[#ffffff] rounded-xl outline outline-2 outline-[#b8ccdc] px-16 py-12">
                    <h2 className="text-xl font-bold text-[#17488D]">
                        {formData ? "Rekomendasi Properti Berdasarkan Profil Anda" : "Rekomendasi Properti Anda"}
                    </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
                            {properties.length > 0 ? (
                                ...
                                <div className="col-span-3 text-center py-12">
                                    <p className="text-[#17488D]">Tidak ada properti yang sesuai dengan kriteria Anda saat ini.</p>
                                    <Link href="/form">
